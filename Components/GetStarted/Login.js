...
import broad1 from '../assets/broadcasting.jpg';
  ...
  return (
    <div className='w-full h-screen flex gap-4 items-start'>
        ...
        <div className='w-full py-4 h-full  flex flex-col'>
            <h3 className='text-2xl font-semibold mb-3 py-5'>Login</h3>
        ...
        <input type="name" placeholder='Enter your name'
            ...
            <div className='flex justify-between'>
               <Link to="/"><button className='w-[180px] h-[50px] bg-blue-500 rounded text-black hover:bg-slate-50 hover:text-black'>LOGIN</button></Link> 
               <Link to="/"><button className='w-[180px] h-[50px] bg-blue-500 rounded text-black hover:bg-slate-50 hover:text-black'>SIGNUP</button></Link>
            </div>
        </div>
